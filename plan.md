...
#### 12.2 修改生产者以收集吞吐量数据
- [ ] 在ProducerTabController中添加消息计数器
- [ ] 实现吞吐量计算逻辑
- [ ] 将吞吐量数据发送到MetricsCollector
- [ ] 添加吞吐量UI显示

#### 12.3 修改消费者以收集吞吐量数据
- [ ] 在ConsumerInstance中添加消息计数器
- [ ] 实现吞吐量计算逻辑
- [ ] 将吞吐量数据发送到MetricsCollector
- [ ] 添加吞吐量UI显示
...
- [ ] 修改消费者，计算消息延迟
- [ ] 实现延迟统计（P50、P95、P99）
- [ ] 将延迟数据发送到MetricsCollector

#### 13.3 实现延迟直方图
- [ ] 创建延迟直方图数据结构
- [ ] 实现延迟数据分布统计
- [ ] 将延迟分布数据发送到MetricsCollector
...
#### 14.2 实现Broker指标收集
- [ ] 创建KafkaMetricsCollector类
- [ ] 实现Broker连接和指标获取
- [ ] 实现CPU、内存、磁盘使用率监控
- [ ] 实现网络流量监控
- [ ] 将Broker指标数据发送到MetricsCollector
...
#### 15.2 集成监控仪表板到主应用
- [ ] 修改MainController，添加监控仪表板入口
- [ ] 更新main-view.fxml，添加监控按钮
- [ ] 实现监控仪表板打开和关闭功能
